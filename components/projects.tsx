          ...
          {projects.map((project) => {
            ...
            return (
              <li key={project.id} data-reveal className="flex">
                ...
                */}
                <article className="group relative isolate flex w-full flex-col overflow-hidden rounded-2xl border border-border/50 bg-card transition-[border-color,box-shadow,translate] duration-300 ease-out hover:-translate-y-0.5 hover:translate-x-1.5 hover:border-primary/40 hover:shadow-2xl hover:shadow-primary/10 focus-within:-translate-y-0.5 focus-within:translate-x-1.5 focus-within:border-primary/60 focus-within:shadow-2xl focus-within:shadow-primary/10 focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 motion-reduce:translate-none">
                  <div className="relative h-48 overflow-hidden">
                    <Image
                      ...
                      className="object-cover transition-[scale,transform] duration-500 ease-out group-hover:scale-105 group-focus-within:scale-105 motion-reduce:scale-100"
                    />
